...
local namespace_id = vim.api.nvim_create_namespace("Gpt4AllCC")
...
M.complete = function()
  ...
  Api.completions({
    ...
    for i = 0, #lines - 1, 1 do
      vim.api.nvim_buf_add_highlight(buffer, namespace_id, "Gpt4AllCompletion", start_row + i, 0, -1)
      vim.api.nvim_buf_add_highlight(popup.bufnr, namespace_id, "Gpt4AllCompletion", i, 0, -1)
    end
